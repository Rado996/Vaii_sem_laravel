        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="edit"><a href="{{'http://localhost/Vaii_sem_laravel/public/menu_items/'.$menuItem->id.'/edit'}}" class="editItembtn" data-item="menu" data-itid="{{$menuItem->id}}" id="editMenuItem{{$menuItem->id}}" ><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-brush" viewBox="0 0 16 16">
